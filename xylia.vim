...
syn keyword xylKeyword dup drop swap inc dec dump return if end else syscall while do derefc derefi proc in buffer
syn keyword xylType int char bool ptr
